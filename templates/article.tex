% META %
\title{A Sample \LaTeX \;Article} % < This is the title of the paper.
\author{John Doe} % < This is the author of the paper.
\date{June 2018} % < Alternately use this as subtitle or course number!
...
\iffalse % < set this to \iftrue for titling and \iffalse for no titling
\begin{center}
	\ \\
	\vspace{30pt}
	\textsf{\huge\@title}
...
% BODY %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract} % Here begins the sample article content. Delete from here.
  This a sample \LaTeX document that explains some of the \LaTeX commands
\end{abstract}
...
% Sample article content from csam.montclair.edu/~korlie/sample_article.TEX
