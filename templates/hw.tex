\title{MA661 - Linear Regression}
\author{Jiahua Chen}
\date{November 2018}

\documentclass[11pt, letterpaper]{article} % for a4 sized paper, define a4paper instead of letterpaper
...
\rhead{\small{\@author}}
\lhead{\small{\today}}
\cfoot{\small{\textsc{p. \thepage/\pageref{LastPage}}}}
\headsep = 0.35in
\fancyheadoffset[R]{0.15in}
\fancyheadoffset[L]{0.15in}

\begin{document}
%\noindent
%\large\textbf{Linear Regression Modelling}\\
%\normalsize MA661\\
%Dr. Weiss\\
...
\begin{abstract} % Here begins the sample article content. Delete from here.
  Determining a linear regression trendline to model sets of multivariable data.
\end{abstract}
